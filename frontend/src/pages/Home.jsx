...
const HERO_HOME_MOBILE_480 =
  '/images/home/hero-home-mobile-480.avif'

const HERO_HOME_MOBILE_640 =
  '/images/home/hero-home-mobile-640.avif'

const HERO_HOME_DESKTOP_960 =
  '/images/home/hero-home-desktop-960.avif'

const HERO_HOME_DESKTOP_1440 =
  '/images/home/hero-home-desktop-1440.avif'

const ESPECIALIDADES_HOME = [
  {
    titulo: 'PIZZAS',
    descripcion:
      'Nuestras pizzas 100% hechas a la leña, con productos de alta calidad',
    imagen320:
  ...
  },
  {
    titulo: 'PASTAS',
    descripcion:
      'Recetas italianas auténticas elaboradas con esmero y profesionalismo',
    imagen320:
...
function AnimatedHighlights() {
  ...
  const [contadorPizzas, setContadorPizzas] = useState(10)
  const [contadorPremium, setContadorPremium] = useState(100)
  const [estrellasVisibles, setEstrellasVisibles] = useState(5)
  ...
  |--------------------------------------------------------------------------
  |
  | Las animaciones especiales solamente se ejecutan desde 1024px.
  | En móviles y tablets se muestran directamente los valores finales.
  |
  */
  useEffect(() => {
  ...
  '(hover: hover) and (pointer: fine)'
    ...
    const actualizarTipoPantalla = () => {
      setEsDesktop(mediaQuery.matches)
    }

    actualizarTipoPantalla()

    mediaQuery.addEventListener('change', actualizarTipoPantalla)
  ...
  */
  useEffect(() => {
    // MOBILE / TABLET:
    // valores finales inmediatamente, sin animaciones.
    if (!esDesktop) {
      setAnimarEntrada(false)
      setContadorPizzas(10)
      setContadorPremium(100)
      setEstrellasVisibles(5)
    ...
    */
    ...
    const intervaloPizzas = setInterval(() => {
      pizzas += 1

      if (pizzas >= 10) {
        setContadorPizzas(10)
        clearInterval(intervaloPizzas)

        return
      }

      setContadorPizzas(pizzas)
    }, 90)
    ...
    */
    ...
    const timeoutEstrellas = setTimeout(() => {
      let estrellas = 0

      intervaloEstrellas = setInterval(() => {
        estrellas += 1

        setEstrellasVisibles(estrellas)
  ...
  */
  const cardStyles = `
    ...
    lg:hover:scale-[1.02]
    lg:hover:border-[#F5A300]/40
    lg:hover:bg-white/[0.07]

    lg:hover:shadow-[0_22px_55px_rgba(0,0,0,0.45)]
  `
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Glow - únicamente visible en desktop */}
        <div
          className="
            hidden
            lg:block
        ...
        <div className="relative flex items-center gap-3">
          ...
          <div
            className="
              ...
              lg:group-hover:shadow-[0_0_22px_rgba(245,163,0,0.25)]
            "
          >
            <Flame
              className="
        ...
        <div className="relative flex items-center gap-3">
          ...
          <div
            className="
              ...
              lg:group-hover:shadow-[0_0_22px_rgba(228,0,43,0.25)]
            "
          >
            <ChefHat
              className="
                ...
                return (
                  <Star
                    ...
                    className={`
                      ...
                      lg:drop-shadow-[0_0_7px_rgba(245,163,0,0.85)]
...
function ProductoDestacadoHome() {
  ...
  return (
    <div className="home-producto-destacado flex min-h-[600px] items-start justify-center md:justify-end">
...
export default function Home() {
  return (
    <div className="home-page bg-[#120C08] text-white overflow-hidden relative">
      ...
      {/* ==================== ESPECIALIDADES ==================== */}
      <section className="home-deferred-section home-deferred-specialties relative py-24 sm:py-32 px-4 sm:px-6 bg-gradient-to-b from-[#120C08] via-[#120C08] to-[#0a0604] overflow-hidden">
      ...
      <section className="home-deferred-section home-deferred-menu relative py-24 sm:py-32 px-4 sm:px-6 overflow-hidden">
        {/* Fondo premium */}
      ...
      {/* ==================== CTA FINAL ==================== */}
      <section className="home-deferred-section home-deferred-cta relative py-16 sm:py-24 px-4 sm:px-6 border-t border-white/10 text-center overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
      ...
      {/* ==================== FOOTER ==================== */}
      <footer className="home-deferred-section home-deferred-footer relative border-t border-white/10 py-8 sm:py-12 px-4 sm:px-6 bg-black/30 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
